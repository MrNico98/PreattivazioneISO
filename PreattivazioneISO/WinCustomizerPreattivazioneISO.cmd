...
cls
color 07
title Preattivazione ISO WinCustomizerGUI
...
%eline%
echo: Avvia l'exe come amministratore.
goto done2
)
...
if exist "!desktop!\" (
%eline%
echo: Non trovo il Desktop, annullo...
goto done2
)
...
%eline%
echo $OEM$ presente sul dekstop.
echo _____________________________________________________
goto done2
)

set HWID_Activation.cmd=MrNico98Attivatore.exe
pushd "!_work!"
...
echo _____________________________________________________
%eline%
echo Non trovo 'Wincustomizer Attivatore.exe'.
echo _____________________________________________________
goto done2
)
...
call :ex_color %Green% "$OEM$ Creata con successo."
...
echo:
call :ex_color %_Yellow% "Premi un tasto per uscire..."
pause %nul1%
exit /b
